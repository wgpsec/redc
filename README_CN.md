...
Redc 是 **WgpSec Infra Ecosystem** 的控制面 — 统一调度多云资源与红队基础设施的全生命周期。
...
| 项目 | 定位 |
|------|------|
| [redc-template](https://github.com/wgpsec/redc-template) | 场景仓库 — 预制场景、基础模板、专项模板、插件资源 |
| [Redc](https://github.com/wgpsec/redc) | 控制面（本仓库）— GUI/CLI 统一入口，多云资源调度 |
| [f8x](https://github.com/ffffffff0x/f8x) | 装配引擎 — 目标主机软件安装与环境配置 |
| [redc.wgpsec.org](https://redc.wgpsec.org/) | 在线模板仓库 — 浏览和下载社区模板 |

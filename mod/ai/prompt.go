...
3. **作用域限制**：当用户说"关闭"或"停止"时，只操作本次对话中你创建的场景，不要操作用户的其他已有场景，除非用户明确指定
4. **状态感知**：stop_case 只能操作 running 状态的场景，kill_case 只能操作 running 或 error 状态的场景，已 stopped 的场景无需也不能再次操作

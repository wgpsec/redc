export const i18n = {
  zh: {
   ...
   // SSH Operations
    ...
    f8xGoToDeploy: '去部署', f8xConfirmInstall: '确认安装', f8xConfirmInstallDesc: '将在目标主机上执行安装', f8xChecking: '检测中...',
  ...
  en: {
    ...
    f8xGoToDeploy: 'Deploy', f8xConfirmInstall: 'Confirm Install', f8xConfirmInstallDesc: 'Will execute installation on target host', f8xChecking: 'Checking...',
